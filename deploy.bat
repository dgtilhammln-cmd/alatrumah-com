...
ssh -p 65002 u947770498@82.180.169.175 "cd domains/alatrumah.com && git pull origin main && php artisan migrate --force && php artisan route:clear && php artisan config:clear && php artisan cache:clear"
