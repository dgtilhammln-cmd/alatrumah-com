    ...
    <form action="{{ isset($usp) ? route('admin.usp.update', $usp) : route('admin.usp.store') }}" method="POST" enctype="multipart/form-data">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin-bottom:1.5rem;">
        <div>
          ...
          <input type="number" name="sort_order" value="{{ old('sort_order', $usp->sort_order ?? $nextOrder ?? 0) }}" style="width:100%;padding:.75rem 1rem;border:1.5px solid #E2E8F0;border-radius:12px;font-size:.875rem;outline:none;box-sizing:border-box;">
        </div>
        <div>
