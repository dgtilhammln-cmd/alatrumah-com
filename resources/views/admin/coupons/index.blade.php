            ...
            <td style="padding:1.25rem 1.5rem;text-align:center;">
              <div style="display:flex;align-items:center;justify-content:center;gap:1rem;">
                ...
                <div style="display:flex;gap:.5rem;">
                  <a href="{{ route('admin.coupons.edit', $c->id) }}" style="color:#3B82F6;background:#EFF6FF;border-radius:8px;padding:6px 10px;text-decoration:none;transition:background .2s;" onmouseover="this.style.background='#DBEAFE'" onmouseout="this.style.background='#EFF6FF'">
                    <i class="fas fa-edit"></i>
                  </a>
                  <form action="{{ route('admin.coupons.destroy', $c->id) }}" method="POST" onsubmit="return confirm('Yakin hapus?');" style="margin:0;">
                    @csrf @method('DELETE')
                    <button type="submit" style="color:#EF4444;background:#FEF2F2;border:none;border-radius:8px;padding:6px 10px;cursor:pointer;transition:background .2s;" onmouseover="this.style.background='#FEE2E2'" onmouseout="this.style.background='#FEF2F2'">
