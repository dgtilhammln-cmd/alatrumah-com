        ...
        <div>
            ...
            <div class="premium-card">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="translations[id][meta_keywords]" value="{{ old('translations.id.meta_keywords', $t?->meta_keywords) }}" class="form-input" placeholder="alat rumah, peralatan, tips">
                </div>
