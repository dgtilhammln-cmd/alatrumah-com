        ...
        <div class="addr-grid">
            @foreach($addresses as $addr)
                <div class="addr-card {{ $addr->is_default ? 'is-default' : '' }}">
                    ...
                    <div
                        style="font-size:0.78rem; color:#64748B; margin-top:0.4rem; display:flex; align-items:center; gap:0.25rem;">
                    ...
                    <div class="addr-actions" style="display:flex;gap:0.5rem;margin-top:1rem;">
                        ...
                        @endif
                        <form method="POST" action="{{ route('account.addresses.destroy', $addr) }}" style="flex:1;"
    ...
    @else
        <div class="acc-card">
            <div class="empty-state">
                ...
                <a href="{{ route('cart.index') }}" class="btn-add-addr"
                    style="margin:0 auto; display:inline-flex; align-items:center; gap:0.4rem; text-decoration:none;">
                    <svg width="14" height="14" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
                        <path d="M6 2L3 6v14a2 2 0 002 2h14a2 2 0 002-2V6l-3-4z" />
                        <line x1="3" y1="6" x2="21" y2="6" />
                    </svg>
    ...
    <div class="modal-overlay" id="addAddrModal" onclick="if(event.target===this) this.classList.remove('active')">
        <div class="modal-box">
            <div class="modal-header">
                ...
                <button class="modal-close" onclick="document.getElementById('addAddrModal').classList.remove('active')"
                    type="button">
            ...
            <form method="POST" action="{{ route('account.addresses.store') }}" id="addAddrForm">
                ...
                <div class="form-group" style="margin-bottom:1rem;">
                    ...
                    <input type="text" name="label" id="labelInput" class="form-input"
                        placeholder="Atau ketik label lainnya..." required>
                </div>
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:0.75rem; margin-bottom:1rem;">
                    <div class="form-group">
                        <label class="form-label">Nama Penerima <span>*</span></label>
                        <input type="text" name="receiver_name" class="form-input" placeholder="Nama lengkap penerima"
                            required>
                    </div>
                    <div class="form-group">
                ...
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:0.75rem; margin-bottom:1rem;">
                    <div class="form-group">
                        ...
                        <select id="province_select" class="form-input" required
                            style="appearance:none;background-repeat:no-repeat;background-position:right 0.75rem center;background-size:1em;">
                            <option value="">Pilih Provinsi</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Kota / Kabupaten <span>*</span></label>
                        <select id="city_select" class="form-input" required
                            style="appearance:none;background-repeat:no-repeat;background-position:right 0.75rem center;background-size:1em;">
                ...
                <div class="form-group" style="margin-bottom:1rem;">
                    ...
                    <input type="text" name="postal_code" class="form-input" placeholder="Kode pos" required
                        pattern="[0-9]{5}" maxlength="5">
                </div>
                <div class="form-group" style="margin-bottom:1.5rem;">
                    <label class="form-label">Alamat Lengkap <span>*</span></label>
                    <textarea name="full_address" class="form-input" rows="3"
                        placeholder="Nomor rumah, nama jalan, RT/RW, patokan, dll." required></textarea>
                </div>
    ...
    <div class="modal-overlay" id="editAddrModal" onclick="if(event.target===this) this.classList.remove('active')">
        <div class="modal-box">
            <div class="modal-header">
                ...
                <button class="modal-close" onclick="document.getElementById('editAddrModal').classList.remove('active')"
                    type="button">
                    <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
                        <line x1="18" y1="6" x2="6" y2="18" />
                        <line x1="6" y1="6" x2="18" y2="18" />
            ...
            <form method="POST" action="" id="editAddrForm">
                ...
                <div class="form-group" style="margin-bottom:1rem;">
                    ...
                    <input type="text" name="label" id="editLabelInput" class="form-input"
                        placeholder="Atau ketik label lainnya..." required>
                </div>
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:0.75rem; margin-bottom:1rem;">
                    <div class="form-group">
                ...
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:0.75rem; margin-bottom:1rem;">
                    <div class="form-group">
                        <label class="form-label">Provinsi <span>*</span></label>
                        <select id="edit_province_select" class="form-input" required
                            style="appearance:none;background-repeat:no-repeat;background-position:right 0.75rem center;background-size:1em;">
                            <option value="">Pilih Provinsi</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Kota / Kabupaten <span>*</span></label>
                        <select id="edit_city_select" class="form-input" required
                            style="appearance:none; background-repeat:no-repeat;background-position:right 0.75rem center;background-size:1em;">
                            <option value="">Pilih Provinsi Dulu</option>
                        </select>
                    </div>
                ...
                <div class="form-group" style="margin-bottom:1rem;">
                    <label class="form-label">Kode Pos <span>*</span></label>
                    <input type="text" name="postal_code" id="editPostal" class="form-input" required pattern="[0-9]{5}"
                        maxlength="5">
                </div>
                <div class="form-group" style="margin-bottom:1.5rem;">
                    <label class="form-label">Alamat Lengkap <span>*</span></label>
