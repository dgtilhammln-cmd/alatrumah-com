...
<style>
        ...
        .btn-add-addr:hover { background: #0284C7; transform: translateY(-1px); }
        ...
        .addr-card.is-default { border-color: #0EA5E9; }
        .addr-card:hover { box-shadow: 0 4px 20px rgba(14,165,233,0.1); }
        .addr-default-badge {
            display: inline-flex;
            align-items: center;
            gap: 0.3rem;
        ...
        .addr-name { font-size: 0.875rem; font-weight: 600; color: #334155; margin-bottom: 0.375rem; }
        .addr-detail { font-size: 0.8rem; color: #64748B; line-height: 1.55; margin-bottom: 0.5rem; }
        .addr-actions {
            display: flex;
            align-items: center;
            gap: 0.5rem;
