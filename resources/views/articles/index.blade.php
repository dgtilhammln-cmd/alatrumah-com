@extends('layouts.app')
@section('title', 'Artikel & Tips Alat Rumah — AlatRumah.com')
@section('meta_description', 'Temukan artikel, panduan, dan tips seputar alat rumah tangga, perawatan rumah, dan produk terbaik hanya di AlatRumah.com.')
@section('content')
...
<section class="sv-hero-premium">
    <div class="sv-hero-inner" data-aos="fade-up">
        ...
        <p class="sv-intro">
            ...
            alat rumah tangga berkualitas — hanya di AlatRumah.com.
        </p>
    </div>
</section>
...
<div class="ar-section">
    ...
    <aside class="ar-sidebar">
        ...
        <div class="ar-sidebar-card" style="background:var(--c-accent);border-color:var(--c-accent);" data-aos="fade-up" data-aos-delay="200">
            ...
            <h3 style="font-size:1.125rem;font-weight:700;color:#fff;margin-bottom:0.75rem;line-height:1.3;font-family:var(--font);">Cari Alat Rumah Tangga?</h3>
            <p style="font-size:0.8125rem;color:rgba(255,255,255,0.85);line-height:1.6;margin-bottom:1.25rem;font-family:var(--font);">Temukan ribuan produk alat rumah tangga berkualitas dengan harga terbaik di AlatRumah.com.</p>
