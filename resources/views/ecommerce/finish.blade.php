...
.fin-order-row:not(:last-child) { border-bottom: 1px solid #F1F5F9; }
...
.btn-pay {
    display: inline-flex; width: auto; min-width: 200px;
...
@media(max-width: 768px) {
    .fin-grid { grid-template-columns: 1fr; gap: 1.5rem; }
    .fin-wrap { margin-top: 60px; }
    .fin-card { padding: 2rem 1.5rem; }
}
</style>
    ...
    <div class="fin-grid">
        ...
        <div class="fin-card fin-left">
            ...
            @else
                ...
                <div class="fin-icon-wrap" style="background: linear-gradient(135deg, #FEF3C7, #FDE68A);">
                    <svg width="40" height="40" fill="none" stroke="#D97706" stroke-width="2.5" viewBox="0 0 24 24">
        ...
        <div class="fin-card fin-right">
            <div class="fin-order-box">
                ...
                <div class="fin-order-row" style="margin-top: 1rem; padding-top: 1rem; border-top: 2px dashed #E2E8F0; border-bottom: none;">
                    <span class="label" style="font-weight: 600; color: var(--text); font-size: 1rem;">Total Tagihan</span>
