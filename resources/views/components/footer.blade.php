        ...
        <div>
            <a href="{{ route_locale('home') }}" class="cv-footer-v2-logo-wrap">
                <div class="cv-footer-v2-logo-icon">
                    ...
                    @else
                        <span style="font-weight:900;color:#0EA5E9;font-size:1rem;">AMN</span>
                    @endif
                </div>
                <div>
                    <div class="cv-footer-v2-brand-name">PT. Airlangga Merapi Nusantara</div>
                    <div class="cv-footer-v2-brand-sub">Eksportir Arang Briket Premium</div>
                </div>
            </a>
            ...
            <div class="cv-footer-v2-badges">
                ...
                <span class="cv-footer-v2-badge">
                    <svg width="9" height="9" fill="currentColor" viewBox="0 0 24 24"><path d="M13 10V3L4 14h7v7l9-11h-7z"/></svg>
                    0 Watt
                </span>
                <span class="cv-footer-v2-badge">
                    <svg width="9" height="9" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>
                    Sejak {{ \App\Models\Setting::get('founding_year') ?? '2013' }}
                </span>
                <span class="cv-footer-v2-badge">
                    <svg width="9" height="9" fill="currentColor" viewBox="0 0 24 24"><path d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><path d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                    50+ Kota
                </span>
            </div>
            ...
            <div class="cv-footer-v2-socials">
                @if($wa)
                <a href="javascript:void(0)" onclick="openOrderModal('Footer WA Icon')" class="cv-footer-v2-social-btn" title="WhatsApp" data-track="Footer WA Icon">
        ...
        <div>
            ...
            <ul class="cv-footer-v2-links">
                @if($svc->count())
                    ...
                    @endforeach
                @else
                    <li><a href="{{ route_locale('products') }}">CV-45 (18")</a></li>
                    <li><a href="{{ route_locale('products') }}">CV-60 (24")</a></li>
                    <li><a href="{{ route_locale('products') }}">CV-75 (30")</a></li>
                    <li><a href="{{ route_locale('products') }}">CV-90 (36")</a></li>
                    <li><a href="{{ route_locale('products') }}">CV-105 (42")</a></li>
                @endif
            </ul>
        </div>
        ...
        <div>
            ...
            <div class="cv-footer-v2-contact-item">
                ...
                <div class="cv-footer-v2-contact-text">
                    ...
                    Jl. Kerukunan IX, Komp. Citra Garden 2<br>Blok G1 No.6, Kalideres<br>Jakarta Barat 11830
                </div>
            </div>
    ...
    <div class="cv-footer-v2-bottom-wrap">
        <div class="cv-footer-v2-bottom">
            <div class="cv-footer-v2-copy">
                <strong>{{ $s['copyright'] ?? '© 2013–2025 PT. Airlangga Merapi Nusantara (AMN)' }}</strong>. All rights reserved.
            </div>
